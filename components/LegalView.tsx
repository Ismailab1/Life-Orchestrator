          ...
          {isPrivacy ? (
            ...
            <div className="space-y-8 pb-12">
              ...
              <section>
                ...
                <p className="mt-4">
                  Calendar sync is optional. Revoking access will prevent future calendar reads/writes but will not affect data already stored in your browser's local IndexedDB storage.
                </p>
              </section>
