...
>
> **Purpose:** Evidence-backed talking points for cover letters, personal statements, and application materials. Each point is mapped to the project feature that supports it. Match the talking points to the specific JD keywords you are targeting.
